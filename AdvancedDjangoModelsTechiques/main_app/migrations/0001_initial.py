# Generated by Django 5.0.4 on 2025-11-07 18:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(max_length=13, validators=[django.core.validators.RegexValidator(message="Phone number must start with '+359", regex='^\\+359\\d{9}$')])),
